    ...
    lumi_action: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const actionLookup: KeyValueAny =
                !isLegacyEnabled(options) && ['QBKG03LM', 'QBKG22LM', 'QBKG04LM', 'QBKG21LM'].includes(model.model)
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            switch (key) {
                case 'system_mode':
                    await entity.write(
                        'manuSpecificLumi',
                        {0x0271: {value: getFromLookup(value, {off: 0, heat: 1}), type: 0x20}},
                ...
                case 'preset':
                    await entity.write(
                        'manuSpecificLumi',
                        {0x0272: {value: getFromLookup(value, {manual: 0, auto: 1, away: 2}), type: 0x20}},
                        {manufacturerCode: manufacturerCode},
                    );
                    break;
    ...
    lumi_switch_power_outage_memory: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (
                ...
                await entity.write(
                    'manuSpecificLumi',
                    {0x0517: {value: getFromLookup(targetValue, lookupState), type: 0x20}},
